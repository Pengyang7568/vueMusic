      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div @click="prev" class="icon i-left" :class="disableClass">
              <i class="icon-prev"></i>
            </div>
            <div class="icon i-center" @click="togglePlaying" :class="disableClass">
              <i :class="playIcon"></i>
            </div>
            <div @click="next" class="icon icon-right" :class="disableClass">
              <i class="icon-next"></i>
            </div>
...
import {playerMixin} from 'common/utils/mixin'
